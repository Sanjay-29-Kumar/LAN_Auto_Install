...
class NetworkProtocol:
    ...
    def _accept_connections(self):
        ...
        while self.running:
            try:
                ...
                if client_ip in self.connection_callbacks:
                    self.connection_callbacks[client_ip](True)
    ...
    def _handle_client(self, client_socket: socket.socket, client_ip: str):
        ...
        try:
            ...
            client_socket.close()
            if client_ip in self.connection_callbacks:
                self.connection_callbacks[client_ip](False)
    ...
    def register_connection_callback(self, client_ip: str, callback: Callable):
        """Register connection status callback"""
        self.connection_callbacks[client_ip] = callback
